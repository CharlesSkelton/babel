...
public void wError(int i,String s)throws IOException{int n=nx(s)+8+1;synchronized(o){B=new byte[n];B[0]=0;B[1]=(byte)i;J=4;w(n);B[J++]=-128;w(s);o.write(B);}}
public void w(int i,Object x)throws IOException{int n=nx(x)+8;synchronized(o){B=new byte[n];B[0]=0;B[1]=(byte)i;J=4;w(n);w(x);o.write(B);}}
